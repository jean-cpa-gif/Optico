    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="bg-white dark:bg-slate-900 rounded-lg max-w-md w-full shadow-xl border border-slate-200 dark:border-slate-800">
        <div className="flex justify-between items-center p-4 border-b border-slate-100 dark:border-slate-800">
          <h3 className="text-base font-bold text-slate-800 dark:text-slate-100">Aumentar Posição em {op.ativo}</h3>
        ...
        <div className="p-4 space-y-4">
          <div>
            <label className="block text-[10px] font-semibold text-slate-400 uppercase tracking-wider mb-1">Quantidade a Adicionar</label>
            <input 
          ...
          <div>
            <label className="block text-[10px] font-semibold text-slate-400 uppercase tracking-wider mb-1">
              Preço por Unidade (R$ {isVenda ? 'Crédito' : 'Débito'})
            </label>
            <input 
          ...
          <div>
            <label className="block text-[10px] font-semibold text-slate-400 uppercase tracking-wider mb-1">Data do Aumento</label>
            <input 
          ...
          <div className="bg-amber-50/50 dark:bg-amber-950/10 p-3.5 rounded border border-amber-200/50 dark:border-amber-900/20 space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div>
                ...
                <p className="font-bold font-mono text-slate-800 dark:text-slate-200">{novaQuantidade} un</p>
              </div>
              <div>
              ...
              <div className="col-span-2 pt-1 border-t border-amber-200/30 dark:border-amber-900/10">
        ...
        <div className="p-4 border-t border-slate-100 dark:border-slate-800 flex gap-2">
          ...
          <button 
            onClick={() => qty > 0 && prc > 0 && onConfirm(qty, prc, data)} 
            disabled={qty <= 0 || prc <= 0}
            className="flex-1 py-1.5 bg-amber-500 hover:bg-amber-600 disabled:opacity-50 text-slate-950 font-bold rounded-sm text-xs transition-colors shadow-sm"
          >
            Confirmar Aumento
          </button>
        </div>
